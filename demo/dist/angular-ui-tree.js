        ...
        return {
          ...
          link: function(scope, element, attrs, controllersArr) {
            ...
            var dragStart = function(e) {
              ...
              var eventScope = scope.$handleScope ? scope.$handleScope : scope;
            ...
            var dragMove = function(e) {
              ...
              if (dragElm) {
                ...
                if (!pos.dirAx) {
                  ...
                  // Find closest scope
                  while (!targetController && targetElm[0]) {
                    var className = targetElm[0].className;
                    if (className.indexOf("angular-ui-tree-nodes") > -1) {
                      targetController = targetElm.controller("uiTreeNodes");
                    } else if (className.indexOf("angular-ui-tree-handle") > -1) {
                      targetController = targetElm.controller("uiTreeHandle");
                    } else if (className.indexOf("angular-ui-tree-node") > -1) {
                      targetController = targetElm.controller("uiTreeNode");
                    } else if (className.indexOf("angular-ui-tree") > -1) {
                      targetController = targetElm.controller("uiTree");
                    }
                    targetElm = angular.element(targetElm[0].parentElement);
                  }
                  ...
                  targetNode = targetController.scope;
